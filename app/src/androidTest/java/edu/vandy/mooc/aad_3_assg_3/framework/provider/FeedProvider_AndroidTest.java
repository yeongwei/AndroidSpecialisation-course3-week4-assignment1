package edu.vandy.mooc.aad_3_assg_3.framework.provider;
...
import edu.vandy.mooc.aad_3_assg_3.assignment.providers.FeedProvider;
 ...
 */
public class FeedProvider_AndroidTest extends ProviderTestCase2<FeedProvider> {

    // The class reference of what ContentProvider we are testing
    static final private Class<FeedProvider> providerClassName =
            FeedProvider.class;

    // The Provider's Authority
    static final private String authority = FeedContract.AUTHORITY;
    // URI for Item(s)
     ...
     * Constructor.
     */
    public FeedProvider_AndroidTest() {
    ...
    public FeedProvider_AndroidTest(Class<FeedProvider> providerClass, String providerAuthority) {
        super(providerClassName, authority);
    }
    ...
    protected void setUp() throws Exception {
        ...
        ((MockContentResolver) mMockResolver).addProvider(FeedContract.AUTHORITY, mFeedContentProvider);
    }
