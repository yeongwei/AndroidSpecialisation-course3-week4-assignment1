package edu.vandy.mooc.aad_3_assg_3.assignment.services;
...
import edu.vandy.mooc.aad_3_assg_3.framework.net.NetEntry;
import edu.vandy.mooc.aad_3_assg_3.framework.net.YoutubeFeedParser;
...
public class DownloadAtomFeedService extends IntentService {
    ...
    public void onHandleIntent(Intent intent) {
        ...
        ArrayList<Entry> feeds = (ArrayList<Entry>) this.downloadAtomFeed(uri.toString());

        // Extract the request code.
        int requestCode = intent.getIntExtra(DownloadAtomFeedService.REQUEST_CODE, -1); // Important
   ...
   /*
    ...
    private List<NetEntry> downloadNetEntries(final String urlString)
        ...
        try {
            ...
            Log.d(TAG, "downloaded " + rValues.size() + " NetEntry(s)");
